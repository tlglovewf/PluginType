    ...
    background: Item {
        ...
        Rectangle {
            ...
            Column {
                ...
                BasicText {
                    anchors.horizontalCenter: parent.horizontalCenter
                    text: "frameless 1.0" //appInfo.appName + " " + appInfo.appVersion
                ...
                BasicText {
                    anchors.horizontalCenter: parent.horizontalCenter
                    text: "tuligen" //appInfo.copyRight
                }
                BasicText {
                    anchors.horizontalCenter: parent.horizontalCenter
                    textFormat: Text.RichText

                    text: "Author Tuligen <a href=\"https://blog.csdn.net/tlglove326\">Tuligen</a>"
                    onLinkActivated: {
                        Qt.openUrlExternally("https://blog.csdn.net/tlglove326")
                    }
                    TransArea {
